...
export default function FamilyPage() {
  ...
  return (
    <div className="max-w-md mx-auto px-5 pt-6">
      ...
      {child && <Link href="/id/demo-child-001" className="block bg-white rounded-2xl p-5 border hairline"><p className="font-bold">{child.firstName} {child.lastName}</p><p className="text-xs text-muted mt-1">{tr("Child profile · Guardian managed", "ملف طفل · تحت إدارة ولي الأمر")}</p></Link>}
    </div>
  );
}
