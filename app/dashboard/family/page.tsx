...
import { Baby, ChevronRight, Plus, UserRound } from "lucide-react";
    ...
    <div className="max-w-md mx-auto px-5 pt-6 pb-8">
      ...
      <div className="space-y-3">
        {patients.map((patient) => {
          ...
          const isChild = patient.age > 0 && patient.age < 18;
